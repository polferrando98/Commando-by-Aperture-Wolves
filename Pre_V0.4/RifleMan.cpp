...
RifleMan::RifleMan(int x, int y) : Enemy(x, y)
{
	current_animation = NULL;
	collider = App->collision->AddCollider({(int)position.x+5, (int)position.y, 14, 24 }, COLLIDER_TYPE::COLLIDER_ENEMY, (Module*)App->enemies);
...
void RifleMan::update_animation()
{
